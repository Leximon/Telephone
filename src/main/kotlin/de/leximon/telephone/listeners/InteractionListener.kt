...
fun ShardManager.interactionListener() = listener<ButtonInteractionEvent>(timeout = 30.seconds) { e ->
    ...
    when (e.componentId) {
        ...
        IncomingCallState.HANGUP_ID -> participant.run {
        ...
        IncomingCallState.PICKUP_ID -> participant.run {
        ...
        // Hangup active call
        CallActiveState.HANGUP_ID -> participant.run {
